...
//
//     final testUserModel = testUserModelFromJson(jsonString);

import 'dart:convert';

TestUserModel testUserModelFromJson(String str) => TestUserModel.fromJson(json.decode(str));

String testUserModelToJson(TestUserModel data) => json.encode(data.toJson());
